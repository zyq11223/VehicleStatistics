...
public class CarbelongResultId implements java.io.Serializable {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CarbelongResultId)) return false;
        CarbelongResultId castOther = (CarbelongResultId) other;

        return ((this.getCitySeq() == castOther.getCitySeq()) || (this.getCitySeq() != null && castOther.getCitySeq() != null && this.getCitySeq().equals(castOther.getCitySeq())))
                && ((this.getJgday() == castOther.getJgday()) || (this.getJgday() != null && castOther.getJgday() != null && this.getJgday().equals(castOther.getJgday())))
                && ((this.getPuid() == castOther.getPuid()) || (this.getPuid() != null && castOther.getPuid() != null && this.getPuid().equals(castOther.getPuid())));
    }

    public int hashCode() {
        int result = 17;

        result = 37 * result + (getCitySeq() == null ? 0 : this.getCitySeq().hashCode());
        result = 37 * result + (getJgday() == null ? 0 : this.getJgday().hashCode());
